...
| 2026-07-14 | 小程序社区富文本解析在渲染前移除 HTML 注释，Teams 导入用于幂等去重的来源标记继续保留在数据库但不再显示为正文 | `miniprogram/utils/community-content.js`, `miniprogram/tests/community-content.test.js` |
